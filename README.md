...
I enjoy building practical desktop applications and AI-powered tools that solve everyday problems. I recently developed a strong interest in open-source vibe coding projects and enjoy exploring how AI can help turn ideas into useful software.
...
|:--:|---------|:------:|-----------|
| 001 | Smart File Organizer | ✅ Complete | [Repository](https://github.com/dg-ganesh/smart-file-organizer) |
| 002 | Bulk File Renamer | ✅ Complete | [Repository](https://github.com/dg-ganesh/Bulk-File-Renamer) |
| 003 | Folder Size Analyzer | ✅ Complete | [Repository](https://github.com/dg-ganesh/Folder-Size-Analyzer) |
...
| 015 | Expense Analyzer |  ✅ Complete | [Repository]([https://github.com/dg-ganesh/014-Log-File-Analyzer](https://github.com/dg-ganesh/015-Expense-Analyzer)) |
...
![CustomTkinter](https://img.shields.io/badge/GUI-CustomTkinter-1f6feb)

![pathlib](https://img.shields.io/badge/pathlib-Standard_Library-lightgrey)
![Pillow](https://img.shields.io/badge/Pillow-Image_Processing-blueviolet)
![pypdf](https://img.shields.io/badge/pypdf-PDF_Processing-red)
